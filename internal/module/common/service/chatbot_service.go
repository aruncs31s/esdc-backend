...
func NewChatBotService(chatBotRepo repository.ChatBotRepository, ollamaRepo repository.OllamaRepository, userRepo user_repo.UserRepository) ChatBotService {
